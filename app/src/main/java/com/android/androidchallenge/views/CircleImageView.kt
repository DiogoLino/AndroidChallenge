package com.android.androidchallenge.views
...
class CircleImageView @JvmOverloads constructor(
    ...
    private fun tryCreatingBitmapFrom(drawable: Drawable): Bitmap? {
        try {
            ...
            Timber.e(e, "Error while creating bitmap")
            return null
        }
    }

    private fun createBitmapFor(drawable: Drawable): Bitmap {
        return if (drawable is ColorDrawable || drawable.intrinsicWidth == -1 || drawable.intrinsicHeight == -1) {
